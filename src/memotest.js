...
function configurarJuego(){
    const coloresInicio = ['rojo', 'azul', 'verde', 'amarillo', 'negro', 'blanco'];
    const coloresRepetidos = coloresInicio.concat(coloresInicio);
...
function configurarCuadros($cuadros, colores){
    ...
    coloresRandom.forEach(function(color, index){
